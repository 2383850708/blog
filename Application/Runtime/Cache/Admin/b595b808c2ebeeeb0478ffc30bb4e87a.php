                ...
                <ul class="nav" id="side-menu">
                    <li class="nav-header">
                        <div class="dropdown profile-element">
                            <span><img alt="image" class="img-circle" src="/thinkphp3/Public/img/profile_small.jpg" /></span>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a class="J_menuItem" href="<?php echo U('type/index');?>">分类列表</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="<?php echo U('type/add');?>">添加分类</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                    ...
                    <li>
                        <a   href="#">
                            <i class="fa fa-key "></i>
                            <span class="nav-label">网站维护</span>
                            <span class="fa arrow"></span>
                        </a>
                         <ul class="nav nav-second-level">
                            <li>
                                <a class="J_menuItem" href="<?php echo U('Cache/index');?>">清除缓存</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="#">备份还原数据库</a>
                            </li>
                        </ul>
                    </li>
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-messages">
                                <li class="m-t-xs">
                                    <div class="dropdown-messages-box">
                                        <a href="profile.html" class="pull-left">
                                            <img alt="image" class="img-circle" src="/thinkphp3/Public/img/a7.jpg">
                                        </a>
                                ...
                                <li>
                                    <div class="dropdown-messages-box">
                                        <a href="profile.html" class="pull-left">
                                            <img alt="image" class="img-circle" src="/thinkphp3/Public/img/a4.jpg">
                                        </a>
                                        <div class="media-body ">
            ...
            <div class="row content-tabs">
                ...
                <nav class="page-tabs J_menuTabs">
                    <div class="page-tabs-content">
                        <a href="<?php echo U('Index/index');?>" class="active J_menuTab" data-id="index_v1.html">首页</a>
                    </div>
                </nav>
                    ...
                    <div id="tab-2" class="tab-pane">
                        ...
                        <div>
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="pull-left text-center">
                                        <img alt="image" class="img-circle message-avatar" src="/thinkphp3/Public/img/a1.jpg">
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="pull-left text-center">
                                        <img alt="image" class="img-circle message-avatar" src="/thinkphp3/Public/img/a2.jpg">
                                    </div>
                                    <div class="media-body">
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="pull-left text-center">
                                        <img alt="image" class="img-circle message-avatar" src="/thinkphp3/Public/img/a3.jpg">
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="pull-left text-center">
                                        <img alt="image" class="img-circle message-avatar" src="/thinkphp3/Public/img/a4.jpg">
                                    </div>
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="pull-left text-center">
                                        <img alt="image" class="img-circle message-avatar" src="/thinkphp3/Public/img/a8.jpg">
                                    </div>
                                    <div class="media-body">
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="pull-left text-center">
                                        <img alt="image" class="img-circle message-avatar" src="/thinkphp3/Public/img/a7.jpg">
                                    </div>
                                    <div class="media-body">
